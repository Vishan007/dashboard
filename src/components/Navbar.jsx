    ...
    <div className='flex justify-between p-2 md:mx-6 relative'>
      ...
      <div className='flex'>
        ...
        <NavButton title='Chat' customFunc={() => handleClick('chat')} 
          color={currentColor} dotColor={currentColor} icon={<BsChatLeft />} />
        <NavButton title='Notification' customFunc={() => handleClick('notification')} 
          color={currentColor} dotColor={currentColor} icon={<RiNotification3Line />} />
        ...
        placement='bottom' >
          ...
          hover:bg-light-gray rounded-lg' onClick={()=>handleClick('userProfile')}>
            ...
            <p>
              ...
              style={{color:currentColor}}  >Vishal</span>
            </p>
